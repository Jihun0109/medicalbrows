          ...
          <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
            ...
            <li class="nav-item has-treeview">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item"><a href="/admin/settings-staff-rank" class="nav-link"><p>スタッフスキル管理</p></a></li>
                ...
                <li class="nav-item clickable">
                  <router-link to="/admin/settings-clinic" class="nav-link">
                    <p>クリニック管理</p></a>
                </li>
                <li class="nav-item clickable">
                  <router-link to="/admin/settings-rank" class="nav-link">
                    <p>ランク管理</p></a>
                </li>
                <li class="nav-item clickable">
                  <router-link to="/admin/settings-staff" class="nav-link">
                    <p>スタッフ管理</p></a>
                </li>
                <li class="nav-item clickable">
                  <router-link to="/admin/settings-staff-rank" class="nav-link">
                    <p>スタッフスキル管理</p></a>
                </li>
                <li class="nav-item clickable">
                  <router-link to="/admin/settings-menu" class="nav-link">
                    <p>メニュー管理</p></a>
                </li>
                <li class="nav-item clickable">
                  <router-link to="/admin/settings-tax" class="nav-link">
                    <p>税率管理</p></a>
                </li>
                <li class="nav-item clickable">
                  <router-link to="/admin/settings-shift" class="nav-link">
                    <p>シフト管理</p></a>
                </li>
                <li class="nav-item clickable">
                  <router-link to="/admin/settings-rank-schedule" class="nav-link">
                    <p>ランクスケジュール管理</p></a>
                </li>
                <li class="nav-item clickable">
                  <router-link to="/admin/settings-account" class="nav-link">
                    <p>アカウント管理</p></a>
                </li>
                <li class="nav-item clickable">
                  <router-link to="/admin/settings-operable-part" class="nav-link">
                    <p>施術可能部位管理</p></a>
                </li>
