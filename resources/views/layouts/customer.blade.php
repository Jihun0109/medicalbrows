  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper  d-flex flex-column">
      ...
      <footer class="main-footer">        
          <div class="container d-flex justify-content-center pb-2"><span><small>Copyrgiht &copy; Omotesando Medical Clinic All Right Reserved.</small></span></div>
          <div class="container d-flex justify-content-center"  style="padding:0px;">
            <div class="col-12 btn-group" style="padding:0px;">
              <button type="button" class="col-6 btn btn-secondary btn-flat d-flex justify-content-center" style="font-weight:bold;white-space:normal;">
              ...
              <button type="button" class="btn bg-gradient-default btn-flat" style="width:80px;background-color: #aaa;"><i class="fas fa-caret-up"></i></button>
            </div>            
          </div>
        </div>
      </footer>
