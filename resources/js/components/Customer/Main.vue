        ...
        <div class="reservation-page" v-show="cancelmode === 0">
            <div class="row justify-content-center">
                <b-button-group style=" width:100%; padding-right: 20px;">
                    ...
                    <b-button variant="secondary" class="arrow2 btn btn-lg btn-arrow-right" style="z-index:3"
                                @click="onClickArrowBtn($event, 2)"
                                :class="{setbtn:stage == 2}">
                        <p style="">情報入力</p>
                    </b-button>
                    
                    <b-button variant="secondary" class="arrow3 btn btn-lg btn-primary btn-arrow-right" style="z-index:2"
                                @click="onClickArrowBtn($event, 3)"
                                :class="{setbtn:stage == 3}">
                        <p style="">情報碓認</p>
                    </b-button>
                    
                    <b-button variant="secondary" class="arrow4 btn btn-lg btn-primary btn-arrow-right" style="z-index:1"
                                @click="onClickArrowBtn($event, 4)" 
                                :class="{setbtn:stage == 4}">
                        <p style="">PDF出力</p>
                    </b-button>

                    <b-button variant="secondary" class="arrow5 btn btn-lg btn-primary btn-arrow-right" style="z-index:0"
