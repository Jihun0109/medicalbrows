        ...
        <div v-show="show" style= "backgroud: #2c3e50;" >
            ...
            <div class="confirm-btn">
                <div class="row justify-content-around">
                    <div class="col-auto">
                        <button @click="onClickBack" type="button" class="btn btn-secondary" style="background:#9F9F9F;">戻る</button>
                    </div>
                    <div class="col-auto" >
                        <button  @click="onClickDownload" type="button" class="btn btn-primary" style="backgroud:#307DB9;">ダウンロード</button>
                    </div>
                </div>
            </div>  
        </div>
        <div v-show="!show">
            ...
            <div class="card">
                <div class="card-body row">
                    <div class="col-3 my-auto pdf-btn" @click="onClickPdf('pdf/22.pdf'), outputName = 'スタッフ区分.pdf'">
                        <a href="#"><i class="fas fa-file-pdf" style="font-size:3em; color:rgb(232, 86, 94);"></i></a>
                    </div>                
                    <div class="col">
                        <div class="pdf-btn">
                            <div>親権者同意書</div>
            ...
            <div class="card">
                <div class="card-body row">
                    <div class="col-3 align-self-center pdf-btn" @click="onClickPdf('pdf/11.pdf'), outputName = '表参道メディカルクリニック問診票.pdf'">
                        <a href="#"><i class="fas fa-file-pdf" style="font-size:3em; color:rgb(232, 86, 94);"></i></a>
                    </div>
                    <div class="col">
                        <div class="pdf-btn">
