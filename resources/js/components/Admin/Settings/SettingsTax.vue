      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 v-show="editMode" class="modal-title" id="exampleModalLabel">税率更新</h5>
            <h5 v-show="!editMode" class="modal-title" id="exampleModalLabel">税率追加</h5>
          ...
          <form @submit.prevent="editMode ? updateItem() : createItem()">
            <div class="modal-body">
              <div class="form-group">
                ...
                >{{errormsg(form.errors.get('name'),"name","税率名")}}</div>
              </div>
              <label>税率</label>
              <div class="input-group">
                ...
                <div
                  ...
                  class="invalid-feedback"
                >{{errormsg(form.errors.get('amount'),"amount","税率")}}</div>
              </div>
...
export default {
  ...
  methods: {
    ...
    searchit() {
      axios
        .get("/api/tax?keyword=" + this.keyword)
