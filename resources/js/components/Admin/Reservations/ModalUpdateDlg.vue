  ...
  <div class="modal-dialog modal-dialog-centered" style="width:440px;">
    <div class="modal-content">
        ...
        <form class="update">
          ...
          <div class="row" style="letter-spacing:-1.8px;">
            ...
            <div class="col-sm-8" style="padding-top: 7px;">
              ...
              >{{item.staff_name + '【' + item.rank_full_name + '】'}}</div>
            </div>
          </div>
          <fieldset class="form-group" style="margin-bottom:0px;">
            <div class="row">
          ...
          <div class="row" v-show="item.rank_name !== 'カウセ'">
            ...
            <div class="col-sm-8" style="padding-top: 7px;" v-show="isShow(form.order_type)">
              <select
                ...
                name="counselor"
                class="custom-select custom-select-sm form-control-sm"
                :class="{'is-invalid':form.errors.has('counselor')}"
              >
                <option disabled value>項目を選択してください</option>
      ...
      <div class="modal-footer">
        ...
        <a
          href="#"
          v-on:click="createCustomerInfo"
          class="btn btn-primary"
          style="background:rgb(197, 224, 180); color:black"
        >登録</a>
      </div>
    </div>
  </div>
