<template>
  <div class="container">
    ...
    <div class="modal fade" id="modalInfoDlg">
      <ModalInfoDlg
        v-bind:data="this.item"
        @updateCellStatus="onUpdateCellStatus"
        v-on:changedStatus="onStatusChanged"
    ...
    <div class="modal fade" id="modalUpdateDlg" data-backdrop="static">
      <ModalUpdateDlg
        v-bind:sr_list="this.staff_rank_list"
        :item="this.item"
        v-bind:menus="this.menus"
        v-bind:counselors="this.counselors"
        ...
        <div class="modal-content">
              ...
              <div class="row">
                ...
                <div class="col-9" style="margin-top: 10px; width:100%;">
                  <input
                    ...
                    :class="{'is-invalid':form.errors.has('mailtitle')}"
          ...
          <div class="modal-footer justify-content-center">
            <a
              ...
              data-dismiss="modal"
              class="btn"
              style="width:100px; background:rgb(127, 127, 127); color:white; margin-right: 60px;"
            >キャンセル</a>
            <a
              href="#"
              v-on:click="onClickSendMail"
              class="btn btn-primary"
              style="width:100px; background:rgb(68, 114, 196); color:white"
            >送信</a>
          </div>
        </div>
      </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div
            ...
            style="padding: 70px; font-width:blod;"
          >ステータスを「{{order_status}}」に変更して宜しいですか？</div>
          <!-- dialog buttons -->
          <div class="modal-footer justify-content-center">
            <a
              href="#"
              data-dismiss="modal"
              class="btn"
              style="width:100px; background:#707070; color:black; margin-right: 60px;"
            >キャンセル</a>
            <a
              href="#"
              v-on:click="confirmBtn"
              class="btn btn-primary"
              style="width:100px; background:#1BB9AF; color:black"
            >OK</a>
          </div>
        </div>
      </div>
      ...
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          ...
          <div
            class="modal-body justify-content-center"
            style="padding: 70px; font-width:blod;"
          >もう一度新しい予約を作成しますか？</div>
          <!-- dialog buttons -->
          <div class="modal-footer justify-content-center">
            <a
              href="#"
              v-on:click="cancelUpdateBtn"
              class="btn"
              style="width:100px; background:#707070; color:black; margin-right: 60px;"
            >キャンセル</a>
            <a
              href="#"
              v-on:click="confirmUpdateBtn"
              class="btn btn-primary"
              style="width:100px; background:#1BB9AF; color:black"
            >OK</a>
          </div>
    ...
    <div class="row d-flex justify-content-center" style="padding-bottom: 15px; padding-top: 20px;">
      <button @click="decrement()" type="button" class="btn btn-default btn-sm">
      ...
      <v-date-picker
        ...
        :masks="formats"
      ></v-date-picker>
      <button @click="increment()" type="button" class="btn btn-default btn-sm">
    ...
    <div class="el-row" v-if="clinics.length > 1">
      <button
        v-for="c in clinics"
        :key="c.id"
        type="button"
      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="contentdiv">
            ...
            >
              <grid-item
                @click.native="onCellClicked($event, item, index)"
                v-for="(item, index) in conlayout"
                :x="item.x"
                :y="item.y"
                :w="item.w"
                :h="item.h"
